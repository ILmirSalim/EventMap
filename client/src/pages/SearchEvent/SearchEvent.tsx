...
export const SearchEvent: React.FC = () => {
  ...
  return (
    <div
      className="h-[500px] bg-gradient-to-r from-teal-200 to-lime-200 shadow-xl shadow-white 
      w-[1200px] h-full"
    >
      {isLoading ? (
        <Loader />
            ...
            <div className="flex flex-col ml-[20px]">
              ...
              <div className="flex  flex-wrap">
                {Array.isArray(events) &&
                  events.map((event) => (
                    <div
                      className="p-[10px] m-[10px] w-48 bg-gradient-to-r from-green-400 to-cyan-400 
                    ...
                    >
                      ...
                      <div className="italic">
                        <p className="font-bold">Название:</p> {event.title}
                      </div>
                      <div className="italic">
                      ...
                      <div className="italic">
                        <p className="font-bold">Создал событие:</p>{" "}
                ...
                {events.length === 0 && (
                  <div className="ml-[370px] pt-[30px]">
